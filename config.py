...
#ABSOLUTE_DIR
ABSOLUTE_DIR = 'D:\Documents\Code\FaceRecord/'
...
#DAT PATH
STD_LANDMARK_PATH = os.path.join(ABSOLUTE_DIR,'dat/standard_landmark_68pts.npy')
PREDICTOR_PATH = os.path.join(ABSOLUTE_DIR,'dat/shape_predictor_5_face_landmarks.dat')
PREDICTOR_FINE_PATH = os.path.join(ABSOLUTE_DIR,'dat/shape_predictor_68_face_landmarks.dat')

#FILE_PATH
FILE_PATH = os.path.join(ABSOLUTE_DIR,'files')
CROP_PATH = os.path.join(ABSOLUTE_DIR,'crop')
